...
$("#search-sort").selectbox({
    onChange: function(val, inst) {
        ...
        if ($('#input_store_select_search').length) {
            $('#input_store_select_search').val(val);
        } else {
            let input_store_select = $('<input type="hidden" id="input_store_select_search" />');
            $('body').append(input_store_select);
            $('#input_store_select_search').val(val);
        }
        console.log(val + ' tr');
    }
...
function init_BookingOne() {
    ...
    $('.time-select__item').click(function() {
        ...
        if ($('#input_store_times_booking').length) {
            $('#input_store_times_booking').val(chooseTime);
        } else {
            let input_store_time = $('<input type="hidden" id="input_store_times_booking" />');
            $('body').append(input_store_time);
            $('#input_store_times_booking').val(chooseTime);
        }
        ...
        // express.writeFile("input.json", JSON.stringify(chooseTime), (err) => {
    ...
    $('.datepicker__input').change(function() {
        //data element change
        var chooseDate = $('.datepicker__input').val();
        if ($('#input_store_date_booking').length) {
            $('#input_store_date_booking').val(chooseDate);
        } else {
            let input_store_date = $('<input type="hidden" id="input_store_date_booking" />');
            $('body').append(input_store_date);
            $('#input_store_date_booking').val(chooseDate);
        }
