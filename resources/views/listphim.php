...
<head>
    ...
    <!-- Mobile Specific Metas-->
        ...
        <script type="text/javascript" src="<?php echo asset('app/listphim.js') ; ?>"></script>
    <!-- Fonts -->
    ...
    <div class="wrapper">
        ...
        <div class="search-wrapper">
            <div class="container container--add">
                <form id='search-form' method='get' class="search">
                    <input type="text" class="search__field" placeholder="Search" ng-model="search_text">
        ...
        <section class="container">
            <div class="col-sm-12">
                ...
                <!-- Movie preview item -->
                <div class="movie movie--preview movie--full release" ng-repeat="item in listphim">
                    ...
                    <div class="col-sm-9 col-md-10 col-lg-10 movie__about">
                            <a href='xemchitiet' ng-click="xemchitiet(item.MaPhim)" class="movie__title link--huge">{{item.TenPhim}} ({{item.NamSX}})</a>

                            <p class="movie__time">105 min</p>

                            <p class="movie__option"><strong>Country: </strong><a href="#">{{item.QuocGia}}</a></p>
                            <p class="movie__option"><strong>Category: </strong><a href="#">{{item.TenTheLoai}}</a></p>
                            <p class="movie__option"><strong>Release date: </strong>{{item.NgayMua}}</p>
                            <p class="movie__option"><strong>Age restriction: </strong><a href="#">{{item.AgeDuocXem}}</a></p>
                            ...
                            <div class="preview-footer">
                                <div class="movie__rate"><div class="score"></div><span class="movie__rate-number">170 votes</span> <span class="movie__rating">{{item.DanhGia}}</span></div>
