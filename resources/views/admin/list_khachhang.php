<!DOCTYPE html>
<html ng-app="list_khachhang-app">
...
<body ng-controller="list_khachhangController">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row">
            ...
            <div class="col-lg-4" ng-repeat="item in listkhachhang | filter: search_text | orderBy: 'TenKH'">
                <div class="contact-box">
                    <a class="row" href="#" ng-click="profile(item)">
                    <div class="col-4">
                        <div class="text-center">
                            <img alt="image" class="rounded-circle m-t-xs img-fluid" src="<?php echo asset('template/img_user/img_khachhang/{{item.Anh}}') ; ?>">
                            <div class="m-t-xs font-bold">{{item.CMND}}</div>
                        </div>
                    </div>
                    <div class="col-8">
                        <h3><strong>{{item.TenKH}}</strong></h3>
