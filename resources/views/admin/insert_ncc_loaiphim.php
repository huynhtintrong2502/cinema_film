...
<!DOCTYPE html>
<html ng-app="insert_ncc_loaiphim-app">
...
<head>
    ...
    <title>Admin Cinema | Insert</title>
    <script type="text/javascript" src="<?php echo asset('app/lib/angular.min.js') ; ?>"></script>
    <script type="text/javascript" src="<?php echo asset('app/admin/insert_ncc_loaiphim.js') ; ?>"></script>
...
<body ng-controller="insert_ncc_loaiphimController">
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>Thêm nhà cung cấp - loại phim</h2>
                <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                <li><a class="nav-link active" data-toggle="tab" href="#tab-1"> Thể loại</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#tab-2"> Nhà cung cấp</a></li>
                            </ul>
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Chọn thể loại:</label>
                                                <div class="col-sm-10">
                                                    <select  ng-model="selected_theloai" class="form-control" placeholder="Tên thể loại"  ng-click="load_theloai(selected_theloai)">
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Thể loại:</label>
                                                <div class="col-sm-10"><input type="text"  class="form-control" placeholder="Thể loại" ng-model="tentheloai"></div>
                                            </div>
                                        ...
                                        <div class="btn-group">
                                            <button  class="btn btn-primary btn-sm -toggle" ng-click="savechange_theloai(selected_theloai)">Save changes</button>
                                           
                                        </div>
                                        <div class="btn-group">
                                            <button  class="btn btn-warning btn-sm -toggle" ng-click="delete_theloai(selected_theloai)">Delete</button>
                                           
                                        </div>
                                        <div class="btn-group">
                                            <button   class="btn btn-default btn-sm -toggle" ng-click="cancel_theloai()">Cancel</button>
                                        </div>
                                ...
                                <div id="tab-2" class="tab-pane">
                                    ...
                                    <fieldset>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Chọn nhà cung cấp:</label>
                                                <div class="col-sm-10">
                                                    <select  ng-model="select_nhacungcap" class="form-control" placeholder="nhà cung cấp"  ng-click="loadnhacungcap(select_nhacungcap)">
                                                        <option  ng-repeat="item in listncc" value="{{item.MaNCC}}" >{{item.TenNCC}}</option>
                                                    </select>
                                                   
                                                </div>
                                            </div>

                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Tên nhà cung cấp:</label>
                                                <div class="col-sm-10"><input type="text"  class="form-control" placeholder="Tên nhà cung cấp" ng-model="tennhacungcap"></div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Địa chỉ:</label>
                                                <div class="col-sm-10"><input type="text"  class="form-control" placeholder="Địa chỉ" ng-model="diachinhacungcap"></div>
                                            </div>
                                       ...
                                       <!-- <div class="form-group row">
                                            <div class="col-sm-4 col-sm-offset-3">
                                                <button class="btn btn-primary btn-sm" ng-click="savechange_ncc(select_nhacungcap)" type="submit">Save changes</button>
                                                <button class="btn btn-white btn-sm" ng-click="cancel_ncc()" type="submit">Cancel</button>
                                                <button class="btn btn-white btn-sm" ng-click="cancel_ncc()" type="submit">Cancel</button>
                                            </div>
                                        
                                        </div>-->
                                        <div class="btn-group">
                                            <button  class="btn btn-primary btn-sm -toggle" ng-click="savechange_ncc(select_nhacungcap)">Save changes</button>
                                           
                                        </div>
                                        <div class="btn-group">
                                            <button  class="btn btn-warning btn-sm -toggle" ng-click="delete_ncc(select_nhacungcap)">Delete</button>
                                           
                                        </div>
                                        <div class="btn-group">
                                            <button   class="btn btn-default btn-sm -toggle" ng-click="cancel_ncc()">Cancel</button>
                                        </div>
