<!DOCTYPE html>
<html ng-app="profile_khachhang-app">
...
<head>
    ...
    <title>Admin Cinema | Profile khách hàng</title>

    <script type="text/javascript" src="<?php echo asset('app/lib/angular.min.js') ; ?>"></script>
    <script type="text/javascript" src="<?php echo asset('app/admin/profile_khachhang.js') ; ?>"></script>
...
<body ng-controller="profile_khachhangController">
                        ...
                        <div>
                            ...
                            <div class="ibox-content profile-content">
                                ...
                                <div class="user-button">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button type="button" ng-click="delete(khachfrst.ID)" class="btn btn-warning btn-sm btn-block"><i class="fa fa-trash-o"></i> Delete</button>
                                        </div>
                                        <div class="col-md-6">
                                            
                                            <button type="button" class="btn btn-primary btn-sm btn-block"><i class="fa fa-line-chart"></i> Edit Ưu đãi</button>    
                                        </div>
                                    </div>
                                </div>
                            </div>
