...
<body class="body"  >	
					...
					<div class="col-12">
						<div class="header__content">
							...
							<a href="#" class="header__logo">
								<img src="<?php echo asset('template/img/partners/themeforest-light-background.png') ; ?>" alt="">
							</a>
							<!-- end header logo -->
	...
	<section class="home">
		...
		<div class="owl-carousel home__bg">
			<div class="item home__cover" data-bg="<?php echo asset('template/img/home/home__bg.jpg') ; ?>"></div>
			<div class="item home__cover" data-bg="<?php echo asset('template/img/home/home__bg2.jpg') ; ?>"></div>
			<div class="item home__cover" data-bg="<?php echo asset('template/img/home/home__bg3.jpg') ; ?>"></div>
			<div class="item home__cover" data-bg="<?php echo asset('template/img/home/home__bg4.jpg') ; ?>"></div>
		</div>
		<!-- end home bg -->
						...
						<div class="item">
							...
							<div class="card card--big">
								<div class="card__cover">
									<img src="<?php echo asset('template/img/covers/cover.jpg') ; ?>" alt="">
						...
						<div class="col-6 col-sm-12 col-lg-6">
							<div class="card card--list">
								<div class="row">
									<div class="col-12 col-sm-4">
										<div class="card__cover">
											<img src="<?php echo asset('template/img/covers/cover.jpg') ; ?>g" alt="">
											<a href="#" class="card__play">
												<i class="icon ion-ios-play"></i>
											</a>
										</div>
				...
				<div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="2-tab">
					<div class="row">
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="card">
								<div class="card__cover">
									<img src="<?php echo asset('template/img/home/home__bg.jpg') ; ?>" alt="">
									<a href="#" class="card__play">
										<i class="icon ion-ios-play"></i>
									</a>
								</div>
	...
	<!-- expected premiere -->
	<section class="section section--bg" data-bg="<?php echo asset('template/img/section/section.jpg') ; ?>">
		<div class="container">
			<div class="row">
				<!-- section title -->
				<div class="col-12">
			...
			<div class="row">
				...
				<div class="col-6 col-sm-4 col-md-3 col-lg-2">
					<a href="#" class="partner">
						<img src="<?php echo asset('template/img/partners/themeforest-light-background.png') ; ?>" alt="" class="partner__img">
					</a>
				</div>
				<!-- end partner -->
			...
			<div class="row">
				...
				<div class="col-12 col-md-3">
					...
					<ul class="footer__app">
						<li><a href="#"><img src="<?php echo asset('template/img/partners/themeforest-light-background.png') ; ?>" alt=""></a></li>
						<li><a href="#"><img src="<?php echo asset('template/img/partners/themeforest-light-background.png') ; ?>" alt=""></a></li>
					</ul>
				</div>
				<!-- end footer list -->
