...
<head>
    ...
    <!-- Mobile Specific Metas-->
        ...
        <script type="text/javascript" src="<?php echo asset('app/book_3.js') ; ?>"></script>
    <!-- Fonts -->
...
<body ng-controller="Book3Controller">
    <div class="wrapper">
            ...
            <div class="col-sm-12">
                <div class="checkout-wrapper">
                    ...
                    <ul class="book-result">
                        <li class="book-result__item">Tickets: <span class="book-result__count booking-ticket">{{count_ghe}}</span></li>
                        <li class="book-result__item">One item price: <span class="book-result__count booking-price">{{thuong}} {{trung}} {{vip}}</span></li>
                        <li class="book-result__item">Total: <span class="book-result__count booking-cost">${{sum}}</span></li>
                    </ul>

                    <h2 class="page-heading">Choose payment method</h2>
                    <div class="payment">
                        <a href="#" class="payment__item">
                            <img alt='' src="<?php echo asset('template/images/payment/pay1.png');?>">
                        </a>
                        <a href="#" class="payment__item">
                            <img alt='' src="<?php echo asset('template/images/payment/pay2.png');?>">
                        </a>
                        <a href="#" class="payment__item">
                            <img alt='' src="<?php echo asset('template/images/payment/pay3.png');?>">
                        </a>
                        <a href="#" class="payment__item">
                            <img alt='' src="<?php echo asset('template/images/payment/pay4.png');?>">
                        </a>
                        <a href="#" class="payment__item">
                            <img alt='' src="<?php echo asset('template/images/payment/pay5.png');?>">
                        </a>
                        <a href="#" class="payment__item">
                            <img alt='' src="<?php echo asset('template/images/payment/pay6.png');?>">
                        </a>
                        <a href="#" class="payment__item">
                            <img alt='' src="<?php echo asset('template/images/payment/pay7.png');?>">
                        </a>
                    </div>
                    ...
                    <form id='contact-info' method='post' novalidate="" class="form contact-info">
                        <div class="contact-info__field contact-info__field-mail">
                            <input type='email' name='user-mail' ng-model="email" placeholder='Your email' class="form__mail">
                        </div>
                        <div class="contact-info__field contact-info__field-tel">
                            <input type='tel' name='user-tel' ng-model="phone" placeholder='Phone number' class="form__mail">
                        </div>
                    </form>
                ...
                <div class="order">
                    <a href="#" ng-click="datve()" class="btn btn-md btn--warning btn--wide">purchase</a>
                </div>
        ...
        <div class="booking-pagination">
                <a href="book_2" class="booking-pagination__prev">
