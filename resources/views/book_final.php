...
<head>
    ...
    <!-- Mobile Specific Metas-->
        ...
        <script type="text/javascript" src="<?php echo asset('app/book_final.js') ; ?>"></script>
    <!-- Fonts -->
    ...
    <div class="wrapper place-wrapper">
        ...
        <section class="container" >
            <div class="order-container"  >
                ...
                <div class="ticket" id="ticker_print">
                ...
                <div class="ticket-control">
                    ...
                    <a href="#" class="watchlist list--print" ng-click="printDiv('ticker_print')">Print</a>
                </div>
